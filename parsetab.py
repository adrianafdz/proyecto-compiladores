...
_lr_signature = "startCALL COMP DEF DO ELSE END FOR FUNC ID IF INPUT MAIN NOTHING NUM NUMBER OPFACT OPTERM PRINT PROGRAM RET STR STRING THEN TO TO_NUMBER TO_STRING TYPE WHILEstart : PROGRAM f_start ID f_prog ';' clases vars funciones MAIN f_main '(' ')' '{' estatutos '}' END f_end ';' f_start :f_prog :f_main :f_end : clases : clases clase\n              | emptyclase : TYPE ID f_startclass ':' ID f_clasepadre '{' cvars f_cvars funciones '}' f_endclass \n             | TYPE ID f_startclass '{' cvars f_cvars funciones '}' f_endclass f_startclass :f_clasepadre :cvars : cvars DEF tipo dimension ':' lista_id ';'\n             | emptyf_cvars :f_endclass :funciones : funciones funcion\n                  | emptyfuncion : FUNC ID f_startfunc '(' params ')' ':' tipo f_tipofunc '{' vars estatutos '}' f_endfunc\n               | FUNC ID f_startfunc '(' params ')' ':' NOTHING f_nothing f_tipofunc '{' vars estatutos '}' f_endfunc f_startfunc :f_nothing :f_tipofunc :f_endfunc :vars : vars DEF tipo dimension ':' lista_id ';'\n            | vars DEF ID f_varsobj ':' lista_id_obj ';'\n            | emptyf_varsobj :lista_id : ID f_vars\n                | lista_id ',' ID f_varsf_vars :lista_id_obj : ID f_vars_obj\n                    | lista_id_obj ',' ID f_vars_objf_vars_obj :dimension : '[' NUM f_dim1 ']' f_enddim\n                 | '[' NUM f_dim1 ']' '[' NUM f_dim2 ']' f_enddim\n                 | emptyf_dim1 :f_dim2 :f_enddim :tipo : NUMBER \n            | STRINGparams : pparams \n              | emptypparams : tipo ID f_param\n               | pparams ',' tipo ID f_paramf_param :estatutos : estatutos estatuto \n                 | emptyestatuto : asignacion \n                | while \n                | for \n                | condicion \n                | CALL call_func ';' call_func : func f_end_call f_end_check\n                 | input \n                 | write \n                 | to_num \n                 | to_str\n                 | return f_end_call :func : ID  f_verify_func '(' args ')'\n            | ID  f_varobj ':' ID f_verify_func_composite '(' args ')' f_verify_func :f_varobj :f_verify_func_composite :args : args_list f_end_args\n            | f_end_argsargs_list : expresion f_arg\n                 | args_list ',' expresion f_argf_arg :f_end_args :asignacion : var '=' f_oper expresion ';' var : ID f_varobj ':' ID f_verify_type_composite indexacion f_end_check\n           | ID f_verify_type indexacion f_end_checkindexacion : f_start_array '[' expresion f_index ']' f_end_array\n                 | f_start_array '[' expresion f_index ']' '[' f_next_index expresion f_index ']' f_end_array\n                 | f_no_index emptyf_end_check :f_verify_type :f_verify_type_composite :f_no_index :f_start_array :f_index :f_next_index :f_end_array :expresion : exp\n                 | expresion COMP f_oper exp f_expres\n                 | STR f_string_expr f_string_expr :f_expres :exp : term\n           | exp OPTERM f_oper term f_expf_exp :term : fact\n            | term OPFACT f_oper fact f_termf_term :f_oper :fact : '(' lparen expresion ')' rparen\n            | var\n            | NUM f_fact\n            | OPTERM NUM\n            | CALL func f_return_val f_end_call f_end_checklparen :rparen :f_fact :f_return_val :condicion : IF '(' expresion ')' f_if THEN '{' estatutos '}' condicionp f_endifcondicionp : ELSE f_else '{' estatutos '}'\n                  | empty f_if :f_endif :f_else :while : WHILE f_while '(' expresion f_exprwhile ')' DO '{' estatutos '}' f_endwhile f_while :f_exprwhile :f_endwhile :for : FOR expresion f_for_start TO expresion f_for_to '{' estatutos '}' f_for_end f_for_start :f_for_to :f_for_end :to_num : TO_NUMBER '(' STR ')' \n              | TO_NUMBER '(' var ')' to_str : TO_STRING '(' expresion ')' input : INPUT '(' var ')' write : PRINT '(' write_list ')' write_list : write_list '&' write_listp\n                  | write_listpwrite_listp : STR f_string\n                   | var \n                   | CALL to_strf_string :return : RET '(' expresion ')' empty :"
    
_lr_action_items = {'PROGRAM':([0,],[2,]),'$end':([1,170,],[0,-1,]),'ID':([2,3,11,12,14,19,22,23,31,35,37,51,53,56,57,61,62,66,67,80,81,82,83,84,85,88,92,98,115,123,126,127,134,139,143,144,145,146,147,148,149,151,152,154,156,168,172,173,186,187,188,189,193,206,213,222,223,228,240,241,245,247,248,250,251,255,256,257,260,262,263,264,267,268,269,271,273,274,277,279,280,],[-2,4,-26,16,21,26,-40,-41,38,44,46,-133,69,-24,71,-25,74,78,-48,-47,-49,-50,-51,-52,109,78,130,44,-97,-103,109,78,166,-53,78,78,78,78,78,78,78,-97,-97,-97,78,78,78,203,78,78,78,78,-133,78,-72,-133,-133,78,78,-133,78,-133,-133,78,-84,-133,78,78,78,78,-120,-133,-116,-117,-111,-109,-113,-107,-133,78,-108,]),';':([4,5,43,44,46,47,58,60,71,74,78,93,95,100,101,102,103,104,105,106,107,108,118,119,120,122,124,125,133,135,137,138,140,153,155,157,158,166,167,169,171,184,191,197,204,205,209,210,211,212,216,217,218,219,220,224,226,234,235,236,237,238,242,243,252,261,276,278,],[-3,6,56,-30,-33,61,-28,-31,-30,-33,-79,-29,-32,-81,-5,139,-60,-55,-56,-57,-58,-59,-86,-89,-91,-94,-99,-105,165,-78,-133,170,-78,-88,-101,-100,-106,-80,-74,-77,-54,213,-60,-81,-124,-125,-121,-122,-123,-132,-90,-93,-96,-104,-78,-78,-61,-87,-92,-95,-98,-102,-73,-85,-75,-62,-85,-76,]),'TYPE':([6,7,8,10,76,97,164,196,],[-133,12,-7,-6,-15,-9,-15,-8,]),'DEF':([6,7,8,9,10,11,32,39,40,56,61,63,75,76,97,164,165,193,196,222,223,241,],[-133,-133,-7,14,-6,-26,-133,50,-13,-24,-25,-133,50,-15,-9,-15,-12,-133,-8,14,-133,14,]),'MAIN':([6,7,8,9,10,11,13,15,18,56,61,76,97,164,196,249,258,259,265,],[-133,-133,-7,-133,-6,-26,17,-17,-16,-24,-25,-15,-9,-15,-8,-23,-18,-23,-19,]),'FUNC':([6,7,8,9,10,11,13,15,18,32,39,40,49,
,166,167,169,197,224,242,243,252,276,278,],[-79,115,-81,-78,-133,-80,-74,-77,-81,-78,-73,-85,-75,-85,-76,]),'OPFACT':([78,100,120,122,124,125,135,137,155,157,158,166,167,169,191,197,217,218,219,220,224,226,236,237,238,242,243,252,261,276,278,],[-79,-81,154,-94,-99,-105,-78,-133,-101,-100,-106,-80,-74,-77,-60,-81,154,-96,-104,-78,-78,-61,-95,-98,-102,-73,-85,-75,-62,-85,-76,]),'OPTERM':([78,88,100,115,118,120,122,123,124,125,127,135,137,146,147,148,149,151,152,154,155,156,157,158,166,167,168,169,172,186,187,188,189,191,197,216,217,218,219,220,224,226,228,235,236,237,238,242,243,245,251,252,260,261,276,278,],[-79,121,-81,-97,152,-91,-94,-103,-99,-105,121,-78,-133,121,121,121,121,-97,-97,-97,-101,121,-100,-106,-80,-74,121,-77,121,121,121,121,121,-60,-81,152,-93,-96,-104,-78,-78,-61,121,-92,-95,-98,-102,-73,-85,121,-84,-75,121,-62,-85,-76,]),'COMP':([78,100,117,118,119,120,122,124,125,135,137,153,155,157,158,159,166,167,169,182,183,184,185,190,191,197,198,202,215,216,217,218,219,220,224,226,234,235,236,237,238,242,243,244,252,261,266,276,278,],[-79,-81,151,-86,-89,-91,-94,-99,-105,-78,-133,-88,-101,-100,-106,151,-80,-74,-77,151,151,151,151,151,-60,-81,151,151,151,-90,-93,-96,-104,-78,-78,-61,-87,-92,-95,-98,-102,-73,-85,151,-75,-62,151,-85,-76,]),'TO':([78,100,117,118,119,120,122,124,125,135,137,150,153,155,157,158,166,167,169,191,197,216,217,218,219,220,224,226,234,235,236,237,238,242,243,252,261,276,278,],[-79,-81,-118,-86,-89,-91,-94,-99,-105,-78,-133,186,-88,-101,-100,-106,-80,-74,-77,-60,-81,-90,-93,-96,-104,-78,-78,-61,-87,-92,-95,-98,-102,-73,-85,-75,-62,-85,-76,]),'&':([78,100,135,137,166,167,169,175,176,177,178,197,207,208,211,224,231,242,243,252,276,278,],[-79,-81,-78,-133,-80,-74,-77,206,-127,-131,-129,-81,-128,-130,-123,-78,-126,-73,-85,-75,-85,-76,]),'END':([79,],[101,]),'INPUT':([85,],[110,]),'PRINT':([85,],[111,]),'TO_NUMBER':([85,],[112,]),'TO_STRING':([85,179,],[113,113,]),'RET':([85,],[114,]),'STR':([88,115,123,127,144,145,146,147,148,149,156,168,172,186,206,228,245,251,260,],[119,-97,-103,119,177,180,119,119,119,119,119,119,119,119,177,119,119,-84,119,]),'NOTHING':([90,],[129,]),'THEN':([192,221,],[-110,239,]),'DO':([232,],[246,]),'ELSE':([264,],[270,]),}
...
_lr_productions = [
  ...
  ('func -> ID f_verify_func ( args )','func',5,'p_func','aloop.py',570),
  ('func -> ID f_varobj : ID f_verify_func_composite ( args )','func',8,'p_func','aloop.py',571),
  ('f_verify_func -> <empty>','f_verify_func',0,'p_f_verify_func','aloop.py',574),
  ('f_varobj -> <empty>','f_varobj',0,'p_f_varobj','aloop.py',592),
  ('f_verify_func_composite -> <empty>','f_verify_func_composite',0,'p_f_verify_func_composite','aloop.py',596),
  ('args -> args_list f_end_args','args',2,'p_args','aloop.py',620),
  ('args -> f_end_args','args',1,'p_args','aloop.py',621),
  ('args_list -> expresion f_arg','args_list',2,'p_args_list','aloop.py',624),
  ('args_list -> args_list , expresion f_arg','args_list',4,'p_args_list','aloop.py',625),
  ('f_arg -> <empty>','f_arg',0,'p_f_arg','aloop.py',628),
  ('f_end_args -> <empty>','f_end_args',0,'p_f_end_args','aloop.py',647),
  ('asignacion -> var = f_oper expresion ;','asignacion',5,'p_asignacion','aloop.py',657),
  ('var -> ID f_varobj : ID f_verify_type_composite indexacion f_end_check','var',7,'p_var','aloop.py',664),
  ('var -> ID f_verify_type indexacion f_end_check','var',4,'p_var','aloop.py',665),
  ('indexacion -> f_start_array [ expresion f_index ] f_end_array','indexacion',6,'p_indexacion','aloop.py',669),
  ('indexacion -> f_start_array [ expresion f_index ] [ f_next_index expresion f_index ] f_end_array','indexacion',11,'p_indexacion','aloop.py',670),
  ('indexacion -> f_no_index empty','indexacion',2,'p_indexacion','aloop.py',671),
  ('f_end_check -> <empty>','f_end_check',0,'p_f_end_check','aloop.py',674),
  ('f_verify_type -> <empty>','f_verify_type',0,'p_f_verify_type','aloop.py',678),
  ('f_verify_type_composite -> <empty>','f_verify_type_composite',0,'p_f_verify_type_composite','aloop.py',720),
  ('f_no_index -> <empty>','f_no_index',0,'p_f_no_index','aloop.py',744),
  ('f_start_array -> <empty>','f_start_array',0,'p_f_start_array','aloop.py',751),
  ('f_index -> <empty>','f_index',0,'p_f_index','aloop.py',764),
  ('f_next_index -> <empty>','f_next_index',0,'p_f_next_index','aloop.py',794),
  ('f_end_array -> <empty>','f_end_array',0,'p_f_end_array','aloop.py',801),
  ('expresion -> exp','expresion',1,'p_expresion','aloop.py',836),
  ('expresion -> expresion COMP f_oper exp f_expres','expresion',5,'p_expresion','aloop.py',837),
  ('expresion -> STR f_string_expr','expresion',2,'p_expresion','aloop.py',838),
  ('f_string_expr -> <empty>','f_string_expr',0,'p_f_string_expr','aloop.py',841),
  ('f_expres -> <empty>','f_expres',0,'p_f_expres','aloop.py',846),
  ('exp -> term','exp',1,'p_exp','aloop.py',870),
  ('exp -> exp OPTERM f_oper term f_exp','exp',5,'p_exp','aloop.py',871),
  ('f_exp -> <empty>','f_exp',0,'p_f_exp','aloop.py',875),
  ('term -> fact','term',1,'p_term','aloop.py',899),
  ('term -> term OPFACT f_oper fact f_term','term',5,'p_term','aloop.py',900),
  ('f_term -> <empty>','f_term',0,'p_f_term','aloop.py',904),
  ('f_oper -> <empty>','f_oper',0,'p_f_oper','aloop.py',929),
  ('fact -> ( lparen expresion ) rparen','fact',5,'p_fact','aloop.py',933),
  ('fact -> var','fact',1,'p_fact','aloop.py',934),
  ('fact -> NUM f_fact','fact',2,'p_fact','aloop.py',935),
  ('fact -> OPTERM NUM','fact',2,'p_fact','aloop.py',936),
  ('fact -> CALL func f_return_val f_end_call f_end_check','fact',5,'p_fact','aloop.py',937),
  ('lparen -> <empty>','lparen',0,'p_lparen','aloop.py',950),
  ('rparen -> <empty>','rparen',0,'p_rparen','aloop.py',954),
  ('f_fact -> <empty>','f_fact',0,'p_f_fact','aloop.py',958),
  ('f_return_val -> <empty>','f_return_val',0,'p_f_return_val','aloop.py',964),
  ('condicion -> IF ( expresion ) f_if THEN { estatutos } condicionp f_endif','condicion',11,'p_condicion','aloop.py',990),
  ('condicionp -> ELSE f_else { estatutos }','condicionp',5,'p_condicionp','aloop.py',993),
  ('condicionp -> empty','condicionp',1,'p_condicionp','aloop.py',994),
  ('f_if -> <empty>','f_if',0,'p_f_if','aloop.py',997),
  ('f_endif -> <empty>','f_endif',0,'p_f_endif','aloop.py',1007),
  ('f_else -> <empty>','f_else',0,'p_f_else','aloop.py',1012),
  ('while -> WHILE f_while ( expresion f_exprwhile ) DO { estatutos } f_endwhile','while',11,'p_while','aloop.py',1019),
  ('f_while -> <empty>','f_while',0,'p_f_while','aloop.py',1022),
  ('f_exprwhile -> <empty>','f_exprwhile',0,'p_f_exprwhile','aloop.py',1026),
  ('f_endwhile -> <empty>','f_endwhile',0,'p_f_endwhile','aloop.py',1036),
  ('for -> FOR expresion f_for_start TO expresion f_for_to { estatutos } f_for_end','for',10,'p_for','aloop.py',1043),
  ('f_for_start -> <empty>','f_for_start',0,'p_f_for_start','aloop.py',1046),
  ('f_for_to -> <empty>','f_for_to',0,'p_f_for_to','aloop.py',1056),
  ('f_for_end -> <empty>','f_for_end',0,'p_f_for_end','aloop.py',1072),
  ('to_num -> TO_NUMBER ( STR )','to_num',4,'p_to_num','aloop.py',1084),
  ('to_num -> TO_NUMBER ( var )','to_num',4,'p_to_num','aloop.py',1085),
  ('to_str -> TO_STRING ( expresion )','to_str',4,'p_to_str','aloop.py',1098),
  ('input -> INPUT ( var )','input',4,'p_input','aloop.py',1111),
  ('write -> PRINT ( write_list )','write',4,'p_write','aloop.py',1115),
  ('write_list -> write_list & write_listp','write_list',3,'p_write_list','aloop.py',1118),
  ('write_list -> write_listp','write_list',1,'p_write_list','aloop.py',1119),
  ('write_listp -> STR f_string','write_listp',2,'p_write_listp','aloop.py',1122),
  ('write_listp -> var','write_listp',1,'p_write_listp','aloop.py',1123),
  ('write_listp -> CALL to_str','write_listp',2,'p_write_listp','aloop.py',1124),
  ('f_string -> <empty>','f_string',0,'p_f_string','aloop.py',1131),
  ('return -> RET ( expresion )','return',4,'p_return','aloop.py',1137),
  ('empty -> <empty>','empty',0,'p_empty','aloop.py',1169),
]
